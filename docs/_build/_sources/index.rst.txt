...
To install the Hypermodern Python Tutorial project,
run this command in your terminal:

.. code-block:: console

   $ pip install hypermodern-python-tutorial


Usage
-----

Hypermodern Python Tutorial's usage looks like:

.. code-block:: console

   $ hypermodern-python-tutorial [OPTIONS]
